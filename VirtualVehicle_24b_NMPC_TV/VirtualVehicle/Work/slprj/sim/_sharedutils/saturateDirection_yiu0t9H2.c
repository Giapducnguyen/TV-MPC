#include "rtwtypes.h"
#include "saturateDirection_yiu0t9H2.h"
#include <emmintrin.h>
#include "rt_nonfinite.h"

void saturateDirection_yiu0t9H2(const real_T xk[29], real_T delta_x[124], real_T
  ...
  mLB, int32_T mUB, const real_T ub[29])
{
  ...
  int32_T idx;
  int32_T indexLB_p;
  static real_T lb[29] = { 0.0, -85.0, -85.0, 0.0, -85.0, -85.0, 0.0, -85.0,
