#include "rtwtypes.h"
#include "xgemm_lbU77OB1.h"
#include <emmintrin.h>

void xgemm_lbU77OB1(int32_T m, int32_T n, int32_T k, const real_T A[1089],
                    int32_T lda, const real_T B[105625], int32_T ib0, real_T C
                    [57200])
{
  __m128d tmp;
  int32_T ar;
