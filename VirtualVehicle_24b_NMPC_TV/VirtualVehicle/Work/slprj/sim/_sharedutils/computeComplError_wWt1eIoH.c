#include "rtwtypes.h"
#include "computeComplError_wWt1eIoH.h"
#include "mwmathutil.h"

real_T computeComplError_wWt1eIoH(const real_T xCurrent[68], const real_T cIneq
  [60], const int32_T finiteLB[225], int32_T mLB, const real_T lb[68], const
  int32_T finiteUB[225], int32_T mUB, const real_T ub[68], const real_T lambda
  [401], int32_T iL0)
{
  real_T lbDelta;
  real_T lbLambda;
