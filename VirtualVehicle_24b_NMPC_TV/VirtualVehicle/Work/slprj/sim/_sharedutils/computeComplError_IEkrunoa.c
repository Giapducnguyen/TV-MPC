#include "rtwtypes.h"
#include "computeComplError_IEkrunoa.h"
#include "mwmathutil.h"

real_T computeComplError_IEkrunoa(const real_T xCurrent[51], const real_T cIneq
  [60], const int32_T finiteLB[178], int32_T mLB, const real_T lb[51], const
  int32_T finiteUB[178], int32_T mUB, const real_T ub[51], const real_T lambda
  [322], int32_T iL0)
{
  real_T lbDelta;
  real_T lbLambda;
  ...
  int32_T ubOffset;
  nlpComplError = 0.0;
  for (ubOffset = 0; ubOffset < 60; ubOffset++) {
