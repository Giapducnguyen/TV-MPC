#include "rtwtypes.h"
#include "xgemm_oXJLtSX6.h"
#include <emmintrin.h>

void xgemm_oXJLtSX6(int32_T m, int32_T n, int32_T k, const real_T A[3364],
                    int32_T lda, const real_T B[380689], int32_T ib0, real_T C
                    [204227])
{
  __m128d tmp;
  int32_T ar;
