#include "rtwtypes.h"
#include "saturateDirection_eDPDZp5a.h"
#include <emmintrin.h>

void saturateDirection_eDPDZp5a(const real_T xk[68], real_T delta_x[445], real_T
  ...
  mLB, int32_T mUB)
{
  ...
  static const real_T ub[68] = { 250.0, 250.0, 250.0, 250.0, 250.0, 250.0, 250.0,
    ...
    10.0, 2.0, 10.0, 2.0, 10.0, 2.0, 250.0, 250.0, 10.0, 2.0, 1.0, 0.2 };
