#include "rtwtypes.h"
#include "saturateDirection_CciSBAdv.h"
#include <emmintrin.h>

void saturateDirection_CciSBAdv(const real_T xk[28], real_T delta_x[161], real_T
  ...
  mLB, int32_T mUB)
{
  ...
  static const real_T ub[28] = { 250.0, 250.0, 250.0, 250.0, 250.0, 250.0, 250.0,
    250.0, 250.0, 250.0, 10.0, 2.0, 10.0, 2.0, 10.0, 2.0, 10.0, 2.0, 10.0, 2.0,
    10.0, 2.0, 250.0, 250.0, 10.0, 2.0, 0.1, 0.02 };
