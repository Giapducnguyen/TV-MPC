#include "rtwtypes.h"
#include "xgemm_mAR4A2NY.h"
#include <emmintrin.h>

void xgemm_mAR4A2NY(int32_T m, int32_T n, int32_T k, const real_T A[3721],
                    int32_T lda, const real_T B[78961], int32_T ib0, real_T C
                    [42150])
{
  __m128d tmp;
  int32_T ar;
