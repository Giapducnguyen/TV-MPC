#include "rtwtypes.h"
#include "xgemm_XCQo5rT7.h"
#include <emmintrin.h>

void xgemm_XCQo5rT7(int32_T m, int32_T n, int32_T k, const real_T A[1764],
                    int32_T lda, const real_T B[133225], int32_T ib0, real_T C
                    [74095])
{
  __m128d tmp;
  int32_T ar;
