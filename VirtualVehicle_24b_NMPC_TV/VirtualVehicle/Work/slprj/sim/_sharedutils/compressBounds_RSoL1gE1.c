#include "rtwtypes.h"
#include "compressBounds_RSoL1gE1.h"
#include "mwmathutil.h"
#include "rt_nonfinite.h"

void compressBounds_RSoL1gE1(int32_T indexLB[271], int32_T indexUB[271], int32_T
  indexFixed[271], const real_T ub[50], int32_T *mLB, int32_T *mUB, int32_T
  *mFixed)
{
  real_T lb;
  int32_T idx;
