#include "rtwtypes.h"
#include "xgemm_hqYtOfX0.h"
#include <emmintrin.h>

void xgemm_hqYtOfX0(int32_T m, int32_T n, int32_T k, const real_T A[6400],
                    int32_T lda, const real_T B[662596], int32_T ib0, real_T C
                    [344322])
{
  __m128d tmp;
  int32_T ar;
