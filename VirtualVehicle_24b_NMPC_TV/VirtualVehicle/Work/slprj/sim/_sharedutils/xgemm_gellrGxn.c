#include "rtwtypes.h"
#include "xgemm_gellrGxn.h"
#include <emmintrin.h>

void xgemm_gellrGxn(int32_T m, int32_T n, int32_T k, const real_T A[3025],
                    int32_T lda, const real_T B[315844], int32_T ib0, real_T C
                    [167476])
{
  __m128d tmp;
  int32_T ar;
