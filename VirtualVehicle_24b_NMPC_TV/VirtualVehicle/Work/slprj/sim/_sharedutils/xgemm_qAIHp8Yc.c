#include "rtwtypes.h"
#include "xgemm_qAIHp8Yc.h"
#include <emmintrin.h>

void xgemm_qAIHp8Yc(int32_T m, int32_T n, int32_T k, const real_T A[11236],
                    int32_T lda, const real_T B[484416], int32_T ib0, real_T C
                    [254040])
{
  __m128d tmp;
  int32_T ar;
