#include "rtwtypes.h"
#include "pdist2_yh2n5xTe.h"
#include <emmintrin.h>
#include "mwmathutil.h"
#include "rt_nonfinite.h"

void pdist2_yh2n5xTe(const real_T Xin[10], const real_T Yin[200], const real_T
                     varargin_1[10], real_T D[20])
{
  __m128d tmp;
  real_T Y[200];
  real_T param[10];
  ...
  for (b_jj = 0; b_jj < 20; b_jj++) {
    ...
    for (c_jj = 0; c_jj < 10; c_jj++) {
      Y[c_jj + 10 * b_jj] = Yin[20 * c_jj + b_jj];
    }
  }
