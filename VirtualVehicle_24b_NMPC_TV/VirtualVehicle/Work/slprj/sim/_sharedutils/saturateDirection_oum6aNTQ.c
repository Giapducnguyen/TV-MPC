#include "rtwtypes.h"
#include "saturateDirection_oum6aNTQ.h"
#include <emmintrin.h>

void saturateDirection_oum6aNTQ(const real_T xk[108], real_T delta_x[721],
  ...
  int32_T mLB, int32_T mUB)
{
  ...
  static const real_T ub[108] = { 250.0, 250.0, 250.0, 250.0, 250.0, 250.0,
    ...
    10.0, 2.0, 10.0, 2.0, 10.0, 2.0, 10.0, 2.0, 10.0, 2.0, 10.0, 2.0, 10.0, 2.0,
    10.0, 2.0, 10.0, 2.0, 10.0, 2.0, 10.0, 2.0, 10.0, 2.0, 10.0, 2.0, 10.0, 2.0,
    10.0, 2.0, 10.0, 2.0, 10.0, 2.0, 10.0, 2.0, 10.0, 2.0, 250.0, 250.0, 10.0,
    2.0, 1.0, 0.2 };
