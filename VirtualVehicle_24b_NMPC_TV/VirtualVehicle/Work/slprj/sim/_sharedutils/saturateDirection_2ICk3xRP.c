#include "rtwtypes.h"
#include "saturateDirection_2ICk3xRP.h"
#include <emmintrin.h>
#include "rt_nonfinite.h"

void saturateDirection_2ICk3xRP(const real_T xk[40], real_T delta_x[191], real_T
  xstarqp[191], const int32_T indexLB[191], const int32_T indexUB[191], int32_T
  mLB, int32_T mUB)
{
  real_T tmp[2];
