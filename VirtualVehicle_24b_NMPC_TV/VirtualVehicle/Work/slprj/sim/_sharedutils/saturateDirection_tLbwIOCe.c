#include "rtwtypes.h"
#include "saturateDirection_tLbwIOCe.h"
#include <emmintrin.h>

void saturateDirection_tLbwIOCe(const real_T xk[68], real_T delta_x[441], real_T
  ...
  mLB, int32_T mUB)
{
  ...
  static const real_T ub[68] = { 250.0, 250.0, 250.0, 250.0, 250.0, 250.0, 250.0,
    ...
    10.0, 2.0, 10.0, 2.0, 10.0, 2.0, 250.0, 250.0, 10.0, 2.0, 0.01, 0.002 };
