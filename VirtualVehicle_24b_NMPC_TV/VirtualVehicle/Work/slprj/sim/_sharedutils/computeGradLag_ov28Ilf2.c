#include "rtwtypes.h"
#include "computeGradLag_ov28Ilf2.h"
#include <string.h>

void computeGradLag_ov28Ilf2(real_T workspace[721], int32_T nVar, const real_T
  grad[721], const real_T AineqTrans[291284], const real_T AeqTrans[74984],
