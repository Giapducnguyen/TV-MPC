#include "rtwtypes.h"
#include "pdist2_zEimCvW1.h"
#include <emmintrin.h>
#include "mwmathutil.h"
#include "rt_nonfinite.h"

void pdist2_zEimCvW1(const real_T Xin[7], const real_T Yin[84], const real_T
                     varargin_1[7], real_T D[12])
{
  __m128d tmp;
  real_T Y[84];
  real_T param[7];
  ...
  for (b_jj = 0; b_jj < 12; b_jj++) {
    ...
    for (c_jj = 0; c_jj < 7; c_jj++) {
      Y[c_jj + 7 * b_jj] = Yin[12 * c_jj + b_jj];
    }
  }
