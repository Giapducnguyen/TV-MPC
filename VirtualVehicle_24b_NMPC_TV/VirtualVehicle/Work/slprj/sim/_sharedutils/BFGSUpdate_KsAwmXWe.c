#include "rtwtypes.h"
#include "BFGSUpdate_KsAwmXWe.h"
#include <emmintrin.h>

boolean_T BFGSUpdate_KsAwmXWe(int32_T nvar, real_T Bk[65025], const real_T sk
  [1378], real_T yk[1378], real_T workspace[3585556])
{
  __m128d tmp;
  __m128d tmp_p;
  real_T curvatureS;
