#include "rtwtypes.h"
#include "xgemm_fIjYZ6pB.h"
#include <emmintrin.h>

void xgemm_fIjYZ6pB(int32_T m, int32_T n, int32_T k, const real_T A[3249],
                    int32_T lda, const real_T B[316969], int32_T ib0, real_T C
                    [164396])
{
  __m128d tmp;
  int32_T ar;
