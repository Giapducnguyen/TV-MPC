#include "rtwtypes.h"
#include "computePrimalFeasError_efQblVNZ.h"
#include "mwmathutil.h"

real_T computePrimalFeasError_efQblVNZ(const real_T x[51], const real_T cIneq[54],
  const real_T cEq[33], const int32_T finiteLB[172], int32_T mLB, const real_T
  lb[51], const int32_T finiteUB[172], int32_T mUB, const real_T ub[51])
{
  real_T feasError;
  int32_T c_idx;
  int32_T finiteLB_p;
