#include "rtwtypes.h"
#include "computeGradLag_4pPoBAet.h"
#include <string.h>

void computeGradLag_4pPoBAet(real_T workspace[449], int32_T nVar, const real_T
  grad[449], const real_T AineqTrans[113148], const real_T AeqTrans[28736],
