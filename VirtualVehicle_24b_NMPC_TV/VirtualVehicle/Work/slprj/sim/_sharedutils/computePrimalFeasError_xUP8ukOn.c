#include "rtwtypes.h"
#include "computePrimalFeasError_xUP8ukOn.h"
#include "mwmathutil.h"

real_T computePrimalFeasError_xUP8ukOn(const real_T x[138], const real_T cIneq
  [210], const real_T cEq[48], const int32_T finiteLB[445], int32_T mLB, const
  real_T lb[138], const int32_T finiteUB[445], int32_T mUB, const real_T ub[138])
{
  real_T feasError;
  int32_T c_idx;
  int32_T finiteLB_p;
