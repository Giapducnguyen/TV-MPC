#include "rtwtypes.h"
#include "xgemm_GMCd1pXT.h"
#include <emmintrin.h>

void xgemm_GMCd1pXT(int32_T m, int32_T n, int32_T k, const real_T A[3844],
                    int32_T lda, const real_T B[616225], int32_T ib0, real_T C
                    [332055])
{
  __m128d tmp;
  int32_T ar;
