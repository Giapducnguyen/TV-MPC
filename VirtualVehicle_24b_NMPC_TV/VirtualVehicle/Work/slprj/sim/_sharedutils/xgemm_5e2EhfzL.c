#include "rtwtypes.h"
#include "xgemm_5e2EhfzL.h"
#include <emmintrin.h>

void xgemm_5e2EhfzL(int32_T m, int32_T n, int32_T k, const real_T A[1764],
                    int32_T lda, const real_T B[275625], int32_T ib0, real_T C
                    [148575])
{
  __m128d tmp;
  int32_T ar;
