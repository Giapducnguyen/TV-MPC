#include "rtwtypes.h"
#include "xgemm_HHIBNG9w.h"
#include <emmintrin.h>

void xgemm_HHIBNG9w(int32_T m, int32_T n, int32_T k, const real_T A[7744],
                    int32_T lda, const real_T B[168100], int32_T ib0, real_T C
                    [89790])
{
  __m128d tmp;
  int32_T ar;
