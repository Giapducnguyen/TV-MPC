#include "rtwtypes.h"
#include "computeComplError_fFKEDQy1.h"
#include "mwmathutil.h"

real_T computeComplError_fFKEDQy1(const real_T xCurrent[78], const real_T cIneq
  [90], const int32_T finiteLB[265], int32_T mLB, const real_T lb[78], const
  int32_T finiteUB[265], int32_T mUB, const real_T ub[78], const real_T lambda
  [481], int32_T iL0)
{
  real_T lbDelta;
  real_T lbLambda;
  ...
  int32_T ubOffset;
  nlpComplError = 0.0;
  for (ubOffset = 0; ubOffset < 90; ubOffset++) {
