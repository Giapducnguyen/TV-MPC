#include "rtwtypes.h"
#include "computeComplError_Z0cEScq1.h"
#include "mwmathutil.h"

real_T computeComplError_Z0cEScq1(const real_T xCurrent[63], const real_T cIneq
  [100], const int32_T finiteLB[230], int32_T mLB, const real_T lb[63], const
  int32_T finiteUB[230], int32_T mUB, const real_T ub[63], const real_T lambda
  [426], int32_T iL0)
{
  real_T lbDelta;
  real_T lbLambda;
  ...
  int32_T ubOffset;
  nlpComplError = 0.0;
  for (ubOffset = 0; ubOffset < 100; ubOffset++) {
