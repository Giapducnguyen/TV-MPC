#include "rtwtypes.h"
#include "computeGradLag_FH8PhDMi.h"
#include <string.h>

void computeGradLag_FH8PhDMi(real_T workspace[535], int32_T nVar, const real_T
  grad[535], const real_T AineqTrans[160500], const real_T AeqTrans[25680],
