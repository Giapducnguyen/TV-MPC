#include "rtwtypes.h"
#include "computePrimalFeasError_x8KvLoud.h"
#include "mwmathutil.h"

real_T computePrimalFeasError_x8KvLoud(const real_T x[93], const real_T cIneq
  [180], const real_T cEq[33], const int32_T finiteLB[340], int32_T mLB, const
  real_T lb[93], const int32_T finiteUB[340], int32_T mUB, const real_T ub[93])
{
  real_T feasError;
  int32_T c_idx;
  int32_T finiteLB_p;
