#include "rtwtypes.h"
#include "computeGradLag_zL29VVrp.h"
#include <string.h>

void computeGradLag_zL29VVrp(real_T workspace[601], int32_T nVar, const real_T
  grad[601], const real_T AineqTrans[192320], const real_T AeqTrans[51686],
