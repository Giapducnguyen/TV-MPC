#include "rtwtypes.h"
#include "computePrimalFeasError_E8skMjHN.h"
#include "mwmathutil.h"

real_T computePrimalFeasError_E8skMjHN(const real_T x[75], const real_T cIneq
  [160], const real_T cEq[27], const int32_T finiteLB[290], int32_T mLB, const
  real_T lb[75], const int32_T finiteUB[290], int32_T mUB, const real_T ub[75])
{
  real_T feasError;
  int32_T c_idx;
  int32_T finiteLB_p;
