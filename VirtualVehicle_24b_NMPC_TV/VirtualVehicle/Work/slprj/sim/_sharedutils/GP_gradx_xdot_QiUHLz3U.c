#include "rtwtypes.h"
#include "GP_gradx_xdot_QiUHLz3U.h"
#include "mwmathutil.h"
#include <emmintrin.h>

void GP_gradx_xdot_QiUHLz3U(const real_T in1[3], real_T delta_Frnt, const real_T
  in3[3], real_T nablax_xdot[9])
{
  ...
  nablax_xdot[2] = (((t25 * t104 + t126) * t3 * -7.6234269119070669E-6 + t100 *
                     1.055179090029042E-5) - t44 * 1.645692158760891E-5) - t17 *
    1.645692158760891E-5;
  t126 = (t13 - t196) * t19;
  ...
  nablax_xdot[4] = ((t100 * -6.1614294516327787E-6 - t44 / 162300.0) - t17 /
                    162300.0) + 1.0;
  nablax_xdot[5] = (((t25 * t104 + t126) * t3 * 7.6234269119070669E-6 - t100 *
                     1.055179090029042E-5) + t44 * 1.645692158760891E-5) + t17 *
    1.645692158760891E-5;
  t126 = (t15 - t20) * t19;
  t104 = t9 - t66;
  ...
  nablax_xdot[7] = ((in1[0] * -0.01 - t100 / 162300.0) + t44 / 162300.0) + t17 /
    162300.0;
  nablax_xdot[8] = ((((t25 * t104 + t126) * t3 * 7.6234269119070669E-6 - t100 *
                      1.055179090029042E-5) - t44 * 1.645692158760891E-5) - t17 *
                    1.645692158760891E-5) + 1.0;
}
