#include "rtwtypes.h"
#include "xgemm_BWkoqSF8.h"
#include <emmintrin.h>

void xgemm_BWkoqSF8(int32_T m, int32_T n, int32_T k, const real_T A[4624],
                    int32_T lda, const real_T B[683929], int32_T ib0, real_T C
                    [368015])
{
  __m128d tmp;
  int32_T ar;
