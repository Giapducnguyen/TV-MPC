#include "rtwtypes.h"
#include "xgemm_IFYu77cE.h"
#include <emmintrin.h>

void xgemm_IFYu77cE(int32_T m, int32_T n, int32_T k, const real_T A[2704],
                    int32_T lda, const real_T B[203401], int32_T ib0, real_T C
                    [106887])
{
  __m128d tmp;
  int32_T ar;
