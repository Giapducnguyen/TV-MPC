#include "rtwtypes.h"
#include "GP_gradx_xdot_wyeyNP8O.h"
#include "mwmathutil.h"
#include <emmintrin.h>

void GP_gradx_xdot_wyeyNP8O(const real_T in1[3], real_T delta_Frnt, const real_T
  in3[3], real_T nablax_xdot[9])
{
  ...
  t123 = ((t22 + t28) + 3110.139193548388) * 0.7;
  t20 = 1.0 / t17;
  t44 = muDoubleScalarAtan2(in1[1] - in1[2] * 1.7, t5_re);
  t48 = 8.0 * t42;
  t5_re = 1.0 / (t16 + t19);
  t120_tmp = ((t23 - t22) + 4850.6758064516134) * 0.7;
  t28 = ((t22 - t28) + 3110.139193548388) * 0.7;
  t126 = -(((t22 + t23) - 4850.6758064516134) * 0.7);
  t53 = 8.0 * t44;
  t61 = 1.0 / (t16 + t17);
  ...
  nablax_xdot[2] = (((t25 * t104 + t126) * t3 * -9.5292836398838323E-6 + t100 *
                     1.318973862536302E-5) - t44 * 2.0571151984511131E-5) - t17 *
    2.0571151984511131E-5;
  t126 = (t13 - t196) * t19;
  ...
  nablax_xdot[4] = ((t100 * -6.1614294516327787E-6 - t44 / 162300.0) - t17 /
                    162300.0) + 1.0;
  nablax_xdot[5] = (((t25 * t104 + t126) * t3 * 9.5292836398838323E-6 - t100 *
                     1.318973862536302E-5) + t44 * 2.0571151984511131E-5) + t17 *
    2.0571151984511131E-5;
  t126 = (t15 - t20) * t19;
  t104 = t9 - t66;
  ...
  nablax_xdot[7] = ((in1[0] * -0.01 - t100 / 162300.0) + t44 / 162300.0) + t17 /
    162300.0;
  nablax_xdot[8] = ((((t25 * t104 + t126) * t3 * 9.5292836398838323E-6 - t100 *
                      1.318973862536302E-5) - t44 * 2.0571151984511131E-5) - t17
                    * 2.0571151984511131E-5) + 1.0;
}
