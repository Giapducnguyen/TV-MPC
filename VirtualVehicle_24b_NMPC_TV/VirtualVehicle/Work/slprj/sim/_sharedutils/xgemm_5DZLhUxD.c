#include "rtwtypes.h"
#include "xgemm_5DZLhUxD.h"
#include <emmintrin.h>

void xgemm_5DZLhUxD(int32_T m, int32_T n, int32_T k, const real_T A[7744],
                    int32_T lda, const real_T B[324900], int32_T ib0, real_T C
                    [170430])
{
  __m128d tmp;
  int32_T ar;
