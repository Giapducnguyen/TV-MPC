#include "rtwtypes.h"
#include "computeComplError_aoPG1ilN.h"
#include "mwmathutil.h"

real_T computeComplError_aoPG1ilN(const real_T xCurrent[75], const real_T cIneq
  [144], const int32_T finiteLB[274], int32_T mLB, const real_T lb[75], const
  int32_T finiteUB[274], int32_T mUB, const real_T ub[75], const real_T lambda
  [520], int32_T iL0)
{
  real_T lbDelta;
  real_T lbLambda;
  ...
  int32_T ubOffset;
  nlpComplError = 0.0;
  for (ubOffset = 0; ubOffset < 144; ubOffset++) {
