#include "rtwtypes.h"
#include "xgemm_TQ6jXzZk.h"
#include <emmintrin.h>

void xgemm_TQ6jXzZk(int32_T m, int32_T n, int32_T k, const real_T A[3600],
                    int32_T lda, const real_T B[564001], int32_T ib0, real_T C
                    [293641])
{
  __m128d tmp;
  int32_T ar;
