#include "rtwtypes.h"
#include "saturateDirection_Y4RkfwLg.h"
#include <emmintrin.h>
#include "rt_nonfinite.h"

void saturateDirection_Y4RkfwLg(const real_T xk[42], real_T delta_x[283], real_T
  ...
  mLB, int32_T mUB)
{
  ...
  static real_T ub[42] = { 50.0, 50.0, 50.0, 50.0, 50.0, 50.0, 50.0, 50.0, 50.0,
    50.0, 50.0, 50.0, 50.0, 50.0, 50.0, 50.0, 50.0, 50.0, 50.0, 50.0, 0.0, 0.0,
