#include "rtwtypes.h"
#include "computeGradLag_n9rwhqGL.h"
#include <string.h>

void computeGradLag_n9rwhqGL(real_T workspace[505], int32_T nVar, const real_T
  grad[505], const real_T AineqTrans[136350], const real_T AeqTrans[24240],
