#include "rtwtypes.h"
#include "xgemm_TvUDipmT.h"
#include <emmintrin.h>

void xgemm_TvUDipmT(int32_T m, int32_T n, int32_T k, const real_T A[3025],
                    int32_T lda, const real_T B[298116], int32_T ib0, real_T C
                    [158340])
{
  __m128d tmp;
  int32_T ar;
