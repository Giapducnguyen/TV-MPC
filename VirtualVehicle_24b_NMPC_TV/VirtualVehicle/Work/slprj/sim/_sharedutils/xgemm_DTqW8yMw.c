#include "rtwtypes.h"
#include "xgemm_DTqW8yMw.h"
#include <emmintrin.h>

void xgemm_DTqW8yMw(int32_T m, int32_T n, int32_T k, const real_T A[1600],
                    int32_T lda, const real_T B[123201], int32_T ib0, real_T C
                    [67041])
{
  __m128d tmp;
  int32_T ar;
