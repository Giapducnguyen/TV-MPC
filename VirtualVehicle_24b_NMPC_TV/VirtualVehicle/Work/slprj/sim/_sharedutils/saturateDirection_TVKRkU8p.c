#include "rtwtypes.h"
#include "saturateDirection_TVKRkU8p.h"
#include <emmintrin.h>

void saturateDirection_TVKRkU8p(const real_T xk[27], real_T delta_x[162], real_T
  ...
  mLB, int32_T mUB)
{
  ...
  int32_T idx;
  int32_T indexLB_p;
  static const int16_T lb[27] = { -300, -300, -300, -300, -300, -300, -300, -300,
    -300, -300, -10, -2, -10, -2, -10, -2, -10, -2, -10, -2, -10, -2, 0, 0, 0, 0,
    0 };

  static const int16_T ub[27] = { 300, 300, 300, 300, 300, 300, 300, 300, 300,
    300, 10, 2, 10, 2, 10, 2, 10, 2, 10, 2, 10, 2, 1, 1, 1, 1, 1 };
