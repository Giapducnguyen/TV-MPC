#include "rtwtypes.h"
#include "saturateDirection_KPno9rqZ.h"
#include <emmintrin.h>
#include "rt_nonfinite.h"

void saturateDirection_KPno9rqZ(const real_T xk[27], real_T delta_x[138], real_T
  xstarqp[138], const int32_T indexLB[138], const int32_T indexUB[138], int32_T
  mLB, int32_T mUB, const real_T ub[27])
{
  real_T tmp[2];
