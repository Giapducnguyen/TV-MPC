#include "rtwtypes.h"
#include "compressBounds_ry1B8Lt5.h"
#include "mwmathutil.h"
#include "rt_nonfinite.h"

void compressBounds_ry1B8Lt5(int32_T indexLB[186], int32_T indexUB[186], int32_T
  indexFixed[186], const real_T ub[45], int32_T *mLB, int32_T *mUB, int32_T
  *mFixed)
{
  real_T lb;
  int32_T idx;
