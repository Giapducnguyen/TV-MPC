#include "rtwtypes.h"
#include "computeComplError_uquVS1IN.h"
#include "mwmathutil.h"

real_T computeComplError_uquVS1IN(const real_T xCurrent[123], const real_T
  cIneq[210], const int32_T finiteLB[430], int32_T mLB, const real_T lb[123],
  const int32_T finiteUB[430], int32_T mUB, const real_T ub[123], const real_T
  lambda[811], int32_T iL0)
{
  real_T lbDelta;
  real_T lbLambda;
