#include "rtwtypes.h"
#include "computeGradLag_3axeWGMi.h"
#include <string.h>

void computeGradLag_3axeWGMi(real_T workspace[560], int32_T nVar, const real_T
  grad[560], const real_T AineqTrans[183680], const real_T AeqTrans[35280],
  ...
  [1056])
{
  ...
  for (b = 0; b <= ix; b++) {
    iL0 = finiteLB[b];
    workspace[iL0 - 1] -= lambda[(mFixed + b) + 391];
  }

  if ((uint16_T)mLB - 1 < 0) {
    iL0 = mFixed + 391;
  } else {
    iL0 = (mFixed + (uint16_T)mLB) + 391;
  }
