#include "rtwtypes.h"
#include "xgemm_0A1ZEOY5.h"
#include <emmintrin.h>

void xgemm_0A1ZEOY5(int32_T m, int32_T n, int32_T k, const real_T A[3364],
                    int32_T lda, const real_T B[110224], int32_T ib0, real_T C
                    [58764])
{
  __m128d tmp;
  int32_T ar;
