#include "rtwtypes.h"
#include "xgemm_0ZgDWijN.h"
#include <emmintrin.h>

void xgemm_0ZgDWijN(int32_T m, int32_T n, int32_T k, const real_T A[3721],
                    int32_T lda, const real_T B[206116], int32_T ib0, real_T C
                    [110776])
{
  __m128d tmp;
  int32_T ar;
