#include "rtwtypes.h"
#include "computeComplError_jbCg8f0u.h"
#include "mwmathutil.h"

real_T computeComplError_jbCg8f0u(const real_T xCurrent[93], const real_T cIneq
  [200], const int32_T finiteLB[360], int32_T mLB, const real_T lb[93], const
  int32_T finiteUB[360], int32_T mUB, const real_T ub[93], const real_T lambda
  [686], int32_T iL0)
{
  real_T lbDelta;
  real_T lbLambda;
  ...
  int32_T ubOffset;
  nlpComplError = 0.0;
  for (ubOffset = 0; ubOffset < 200; ubOffset++) {
