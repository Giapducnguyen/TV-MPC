#include "rtwtypes.h"
#include "compressBounds_WFnyFhJn.h"
#include "mwmathutil.h"
#include "rt_nonfinite.h"

void compressBounds_WFnyFhJn(int32_T indexLB[126], int32_T indexUB[126], int32_T
  indexFixed[126], const real_T ub[25], int32_T *mLB, int32_T *mUB, int32_T
  *mFixed)
{
  real_T lb;
  int32_T idx;
