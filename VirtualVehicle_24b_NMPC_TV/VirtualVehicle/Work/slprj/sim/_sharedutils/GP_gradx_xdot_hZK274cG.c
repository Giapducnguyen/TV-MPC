#include "rtwtypes.h"
#include "GP_gradx_xdot_hZK274cG.h"
#include "mwmathutil.h"
#include <emmintrin.h>

void GP_gradx_xdot_hZK274cG(const real_T in1[3], real_T delta_Frnt, const real_T
  in3[3], real_T nablax_xdot[9])
{
  ...
  t123 = ((t22 + t28) + 3110.139193548388) * 0.899;
  t20 = 1.0 / t17;
  t44 = muDoubleScalarAtan2(in1[1] - in1[2] * 1.7, t5_re);
  t48 = 8.0 * t42;
  t5_re = 1.0 / (t16 + t19);
  t120_tmp = ((t23 - t22) + 4850.6758064516134) * 0.899;
  t28 = ((t22 - t28) + 3110.139193548388) * 0.899;
  t126 = -(((t22 + t23) - 4850.6758064516134) * 0.899);
  t53 = 8.0 * t44;
  t61 = 1.0 / (t16 + t17);
