#include "rtwtypes.h"
#include "xgemm_Njg9SgO8.h"
#include <emmintrin.h>

void xgemm_Njg9SgO8(int32_T m, int32_T n, int32_T k, const real_T A[3025],
                    int32_T lda, const real_T B[294849], int32_T ib0, real_T C
                    [156384])
{
  __m128d tmp;
  int32_T ar;
