#include "rtwtypes.h"
#include "xgemm_mOLABTCB.h"
#include <emmintrin.h>

void xgemm_mOLABTCB(int32_T m, int32_T n, int32_T k, const real_T A[3600],
                    int32_T lda, const real_T B[477481], int32_T ib0, real_T C
                    [249451])
{
  __m128d tmp;
  int32_T ar;
