#include "rtwtypes.h"
#include "xgemm_BYWbLeFg.h"
#include <emmintrin.h>

void xgemm_BYWbLeFg(int32_T m, int32_T n, int32_T k, const real_T A[3721],
                    int32_T lda, const real_T B[149769], int32_T ib0, real_T C
                    [79722])
{
  __m128d tmp;
  int32_T ar;
