#include "rtwtypes.h"
#include "pdist2_gYd75zzh.h"
#include <emmintrin.h>
#include "mwmathutil.h"
#include "rt_nonfinite.h"

void pdist2_gYd75zzh(const real_T Xin[10], const real_T Yin[120], const real_T
                     varargin_1[10], real_T D[12])
{
  __m128d tmp;
  real_T Y[120];
  real_T param[10];
  ...
  for (b_jj = 0; b_jj < 12; b_jj++) {
    ...
    for (c_jj = 0; c_jj < 10; c_jj++) {
      Y[c_jj + 10 * b_jj] = Yin[12 * c_jj + b_jj];
    }
  }
