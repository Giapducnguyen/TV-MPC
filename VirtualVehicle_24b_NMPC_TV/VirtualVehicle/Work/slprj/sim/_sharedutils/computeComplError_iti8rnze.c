#include "rtwtypes.h"
#include "computeComplError_iti8rnze.h"
#include "mwmathutil.h"

real_T computeComplError_iti8rnze(const real_T xCurrent[75], const real_T cIneq
  [128], const int32_T finiteLB[258], int32_T mLB, const real_T lb[75], const
  int32_T finiteUB[258], int32_T mUB, const real_T ub[75], const real_T lambda
  [488], int32_T iL0)
{
  real_T lbDelta;
  real_T lbLambda;
  ...
  int32_T ubOffset;
  nlpComplError = 0.0;
  for (ubOffset = 0; ubOffset < 128; ubOffset++) {
