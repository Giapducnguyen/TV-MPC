#include "rtwtypes.h"
#include "saturateDirection_eeWjxBtv.h"
#include <emmintrin.h>
#include "rt_nonfinite.h"

void saturateDirection_eeWjxBtv(const real_T xk[29], real_T delta_x[124], real_T
  ...
  mLB, int32_T mUB, const real_T ub[29])
{
  ...
  int32_T idx;
  int32_T indexLB_p;
  static real_T lb[29] = { 0.0, -50.0, -50.0, 0.0, -50.0, -50.0, 0.0, -50.0,
