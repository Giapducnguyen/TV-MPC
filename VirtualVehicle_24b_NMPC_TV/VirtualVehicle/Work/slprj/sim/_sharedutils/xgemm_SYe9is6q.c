#include "rtwtypes.h"
#include "xgemm_SYe9is6q.h"
#include <emmintrin.h>

void xgemm_SYe9is6q(int32_T m, int32_T n, int32_T k, const real_T A[2500],
                    int32_T lda, const real_T B[271441], int32_T ib0, real_T C
                    [141191])
{
  __m128d tmp;
  int32_T ar;
