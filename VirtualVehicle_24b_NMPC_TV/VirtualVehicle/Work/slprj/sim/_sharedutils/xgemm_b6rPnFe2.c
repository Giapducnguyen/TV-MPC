#include "rtwtypes.h"
#include "xgemm_b6rPnFe2.h"
#include <emmintrin.h>

void xgemm_b6rPnFe2(int32_T m, int32_T n, int32_T k, const real_T A[6084],
                    int32_T lda, const real_T B[194481], int32_T ib0, real_T C
                    [108045])
{
  __m128d tmp;
  int32_T ar;
