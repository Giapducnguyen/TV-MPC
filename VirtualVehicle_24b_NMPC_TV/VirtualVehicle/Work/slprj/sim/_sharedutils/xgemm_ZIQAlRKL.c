#include "rtwtypes.h"
#include "xgemm_ZIQAlRKL.h"
#include <emmintrin.h>

void xgemm_ZIQAlRKL(int32_T m, int32_T n, int32_T k, const real_T A[11025],
                    int32_T lda, const real_T B[1149184], int32_T ib0, real_T C
                    [608896])
{
  __m128d tmp;
  int32_T ar;
