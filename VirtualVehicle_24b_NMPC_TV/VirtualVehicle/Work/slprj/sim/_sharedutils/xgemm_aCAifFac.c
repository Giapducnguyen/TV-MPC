#include "rtwtypes.h"
#include "xgemm_aCAifFac.h"
#include <emmintrin.h>

void xgemm_aCAifFac(int32_T m, int32_T n, int32_T k, const real_T A[3025],
                    int32_T lda, const real_T B[131769], int32_T ib0, real_T C
                    [70422])
{
  __m128d tmp;
  int32_T ar;
