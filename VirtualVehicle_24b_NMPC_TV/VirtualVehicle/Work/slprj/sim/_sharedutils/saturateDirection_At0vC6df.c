#include "rtwtypes.h"
#include "saturateDirection_At0vC6df.h"
#include <emmintrin.h>
#include "rt_nonfinite.h"

void saturateDirection_At0vC6df(const real_T xk[22], real_T delta_x[123], real_T
  xstarqp[123], const int32_T indexLB[123], const int32_T indexUB[123], int32_T
  mLB)
{
  real_T tmp[2];
