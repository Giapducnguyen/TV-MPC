#include "rtwtypes.h"
#include "computeGradLag_IQgzqw8X.h"
#include <string.h>

void computeGradLag_IQgzqw8X(real_T workspace[423], int32_T nVar, const real_T
  grad[423], const real_T AineqTrans[101520], const real_T AeqTrans[25380],
