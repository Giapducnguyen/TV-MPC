#include "rtwtypes.h"
#include "xgemm_JEZ33AsP.h"
#include <emmintrin.h>

void xgemm_JEZ33AsP(int32_T m, int32_T n, int32_T k, const real_T A[2304],
                    int32_T lda, const real_T B[319225], int32_T ib0, real_T C
                    [172325])
{
  __m128d tmp;
  int32_T ar;
