#include "rtwtypes.h"
#include "computeGradLag_Jw2JS70X.h"
#include <string.h>

void computeGradLag_Jw2JS70X(real_T workspace[530], int32_T nVar, const real_T
  grad[530], const real_T AineqTrans[149460], const real_T AeqTrans[25440],
