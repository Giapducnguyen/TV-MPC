#include "rtwtypes.h"
#include "saturateDirection_58jtKwbq.h"
#include <emmintrin.h>
#include "rt_nonfinite.h"

void saturateDirection_58jtKwbq(const real_T xk[25], real_T delta_x[136], real_T
  xstarqp[136], const int32_T indexLB[136], const int32_T indexUB[136], int32_T
  mLB, int32_T mUB, const real_T ub[25])
{
  real_T tmp[2];
  ...
  int32_T idx;
  int32_T indexLB_p;
  static real_T lb[25] = { 0.0, -100.0, -100.0, 0.0, -100.0, -100.0, 0.0, -100.0,
