#include "rtwtypes.h"
#include "computePrimalFeasError_ucCs82DX.h"
#include "mwmathutil.h"

real_T computePrimalFeasError_ucCs82DX(const real_T x[123], const real_T cIneq
  [210], const real_T cEq[48], const int32_T finiteLB[430], int32_T mLB, const
  real_T lb[123], const int32_T finiteUB[430], int32_T mUB, const real_T ub[123])
{
  real_T feasError;
  int32_T c_idx;
  int32_T finiteLB_p;
