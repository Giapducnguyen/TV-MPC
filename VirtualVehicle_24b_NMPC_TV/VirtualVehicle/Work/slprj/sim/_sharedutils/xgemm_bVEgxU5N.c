#include "rtwtypes.h"
#include "xgemm_bVEgxU5N.h"
#include <emmintrin.h>

void xgemm_bVEgxU5N(int32_T m, int32_T n, int32_T k, const real_T A[5625],
                    int32_T lda, const real_T B[238144], int32_T ib0, real_T C
                    [125904])
{
  __m128d tmp;
  int32_T ar;
