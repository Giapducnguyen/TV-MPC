#include "rtwtypes.h"
#include "saturateDirection_3Dw0pjfV.h"
#include <emmintrin.h>
#include "rt_nonfinite.h"

void saturateDirection_3Dw0pjfV(const real_T xk[62], real_T delta_x[423], real_T
  xstarqp[423], const int32_T indexLB[423], const int32_T indexUB[423], int32_T
  mLB, int32_T mUB)
{
  real_T tmp[2];
  ...
  int32_T idx;
  int32_T indexLB_p;
  static real_T lb[62] = { -50.0, -50.0, -50.0, -50.0, -50.0, -50.0, -50.0,
  ...
  static real_T ub[62] = { 50.0, 50.0, 50.0, 50.0, 50.0, 50.0, 50.0, 50.0, 50.0,
