#include "rtwtypes.h"
#include "xgemm_omqby2UW.h"
#include <emmintrin.h>

void xgemm_omqby2UW(int32_T m, int32_T n, int32_T k, const real_T A[3600],
                    int32_T lda, const real_T B[113569], int32_T ib0, real_T C
                    [65041])
{
  __m128d tmp;
  int32_T ar;
