#include "rtwtypes.h"
#include "compressBounds_6OIvumiv.h"
#include "mwmathutil.h"
#include "rt_nonfinite.h"

void compressBounds_6OIvumiv(int32_T indexLB[124], int32_T indexUB[124], int32_T
  indexFixed[124], const real_T ub[29], int32_T *mLB, int32_T *mUB, int32_T
  *mFixed)
{
  real_T lb;
  int32_T idx;
  static real_T lb_p[29] = { 0.0, -75.0, -75.0, 0.0, -75.0, -75.0, 0.0, -75.0,
