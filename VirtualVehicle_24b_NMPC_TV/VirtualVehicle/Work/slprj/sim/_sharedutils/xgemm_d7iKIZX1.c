#include "rtwtypes.h"
#include "xgemm_d7iKIZX1.h"
#include <emmintrin.h>

void xgemm_d7iKIZX1(int32_T m, int32_T n, int32_T k, const real_T A[4624],
                    int32_T lda, const real_T B[680625], int32_T ib0, real_T C
                    [367125])
{
  __m128d tmp;
  int32_T ar;
