#include "rtwtypes.h"
#include "compressBounds_75BjLacC.h"
#include <emmintrin.h>

void compressBounds_75BjLacC(int32_T indexLB[331], int32_T indexUB[331], int32_T
