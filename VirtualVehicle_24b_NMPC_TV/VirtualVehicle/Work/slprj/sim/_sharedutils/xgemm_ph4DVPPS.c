#include "rtwtypes.h"
#include "xgemm_ph4DVPPS.h"
#include <emmintrin.h>

void xgemm_ph4DVPPS(int32_T m, int32_T n, int32_T k, const real_T A[5625],
                    int32_T lda, const real_T B[270400], int32_T ib0, real_T C
                    [142480])
{
  __m128d tmp;
  int32_T ar;
