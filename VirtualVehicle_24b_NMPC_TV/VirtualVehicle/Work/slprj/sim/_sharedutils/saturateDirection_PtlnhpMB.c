#include "rtwtypes.h"
#include "saturateDirection_PtlnhpMB.h"
#include <emmintrin.h>

void saturateDirection_PtlnhpMB(const real_T xk[68], real_T delta_x[449], real_T
  xstarqp[449], const int32_T indexLB[449], const int32_T indexUB[449], int32_T
  mLB, int32_T mUB)
{
  real_T tmp[2];
  ...
  static const real_T ub[68] = { 250.0, 250.0, 250.0, 250.0, 250.0, 250.0, 250.0,
    ...
    10.0, 2.0, 10.0, 2.0, 10.0, 2.0, 250.0, 250.0, 10.0, 2.0, 0.1, 0.02 };
