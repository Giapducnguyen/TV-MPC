...
PRODUCT_NAME              = EvPowertrainController4EM
MAKEFILE                  = EvPowertrainController4EM.mk
...
MODELREF_LINK_RSPFILE     = EvPowertrainController4EM_ref.rsp
COMPILER_COMMAND_FILE     = EvPowertrainController4EM_comp.rsp
CMD_FILE                  = EvPowertrainController4EM.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/EvPowertrainController4EM_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=EvPowertrainController4EM -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/sim/EvPowertrainController4EM/EvPowertrainController4EM_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = EvPowertrainController4EM_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/user/MATLAB/Projects/examples/VirtualVehicle_24b_NMPC_TV/VirtualVehicle/Work/slprj/sim/EvPowertrainController4EM/EvPowertrainController4EMlib.lib
...
EvPowertrainController4EM_msf.obj : $(START_DIR)/slprj/sim/EvPowertrainController4EM/EvPowertrainController4EM_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
